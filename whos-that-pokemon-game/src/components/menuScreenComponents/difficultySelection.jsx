  ...
  return (
    <div className="flex flex-col justify-center items-center text-4xl w-3/4">
      <button
        ...
        className=" w-11/12 rounded-2xl m-3 py-1.5 shadow-md bg-gradient-to-b from-sky-500 to-sky-600 flex justify-center justify-items-center	 hover:bg-gradient-to-b hover:from-indigo-500 hover:to-indigo-600 active:bg-gradient-to-b active:from-emerald-500 active:to-emerald-600"
      >
        Easy
      </button>
      <button
